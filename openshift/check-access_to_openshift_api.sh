...
POD=$(oc get pods | awk '/vertx-ignite-kubernetes-[0-9]+-/ && ! /build/ && /Running/ { print $1; }' | head -n 1)
...
oc rsh $POD curl -v \
    ...
    "https://kubernetes.default.svc.cluster.local/api/v1/namespaces/$OPENSHIFT_NAMESPACE/endpoints/my-ignite"
